        ...
        this.$refs[formName].validate(async(valid) => {
          if(valid) {
            ...
            if(res.ok) {
              this.$message({
                type   : 'success',
                message: '欢迎你！'+res.content.real_name
              });
              setStore('user_info',{user_id:res.content.user_id,role:res.content.role});
              if(res.content.role==='教师'){
                this.$router.push('manage')
              }else if(res.content.role==='审核员'){
